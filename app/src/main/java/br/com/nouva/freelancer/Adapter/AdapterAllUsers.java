...
public class AdapterAllUsers extends RecyclerView.Adapter<AdapterAllUsers.ViewHolder> {
    ...
    public AdapterAllUsers(Context context, List<ModelMoreProjects> users) {
        this.users = users;
    ...
    @NonNull
    @Override
    public AdapterAllUsers.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final AdapterAllUsers.ViewHolder holder, int position) {
